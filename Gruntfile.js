...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		watch: {
			src: {
				files: ['src/**/*.js'],
				tasks: ['browserify:fcrypto', 'notify:watch']
			},
			test: {
		...
		notify: {
			watch: {
				options: {
					...
					message: 'browserify finished running', //required
				}
			}
		}
	});
	...
	grunt.registerTask('default', ['clean', 'browserify', 'version', 'uglify', 'notify:watch']);
